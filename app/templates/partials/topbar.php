    ...
    <nav class="navbar top-navbar navbar-expand-md navbar-dark">
        ...
        <div class="navbar-collapse collapse" id="navbarSupportedContent">
                                ...
                                <div class="message-center notifications position-relative" style="height:250px;">
                                    ...
                                    if (isset($notifications) && is_array($notifications)) {
                                        foreach ($notifications as $notification) {
                                            $iconClass = isset($notification['icon_class']) ? $notification['icon_class'] : 'btn-danger';
                                            $icon = isset($notification['icon']) ? $notification['icon'] : 'fa fa-link';
                                            $title = isset($notification['title']) ? $notification['title'] : '';
                                            $desc = isset($notification['desc']) ? $notification['desc'] : '';
                                            $time = isset($notification['time']) ? $notification['time'] : '';
                                    ?>
                                    <!-- Message -->
                                    <a href="javascript:void(0)" class="message-item d-flex align-items-center border-bottom px-3 py-2">
                                        <span class="btn <?php echo $iconClass; ?> rounded-circle btn-circle"><i class="<?php echo $icon; ?>"></i></span>
                                        <div class="w-75 d-inline-block v-middle pl-2">
                                            <h5 class="message-title mb-0 mt-1"><?php echo $title; ?></h5> <span class="font-12 text-nowrap d-block text-muted text-truncate"><?php echo $desc; ?></span> <span class="font-12 text-nowrap d-block text-muted"><?php echo $time; ?></span> </div>
                                    </a>
                                    <?php 
                                        }
                                    } else {
                                        // Default static content if no variable provided
                                    ?>
                                    <!-- Message -->
                                    <a href="javascript:void(0)" class="message-item d-flex align-items-center border-bottom px-3 py-2">
                                ...
                                <div class="message-center message-body position-relative" style="height:250px;">
                                    ...
                                    if (isset($messages) && is_array($messages)) {
                                        foreach ($messages as $message) {
                                            $img = isset($message['img']) ? $message['img'] : '../assets/images/users/1.jpg';
                                            $status = isset($message['status']) ? $message['status'] : 'online';
                                            $name = isset($message['name']) ? $message['name'] : '';
                                            $desc = isset($message['desc']) ? $message['desc'] : '';
                                            $time = isset($message['time']) ? $message['time'] : '';
                                    ?>
                                    <!-- Message -->
                                    <a href="javascript:void(0)" class="message-item d-flex align-items-center border-bottom px-3 py-2">
                                        <span class="user-img position-relative d-inline-block"> <img src="<?php echo $img; ?>" alt="user" class="rounded-circle w-100"> <span class="profile-status rounded-circle <?php echo $status; ?>"></span> </span>
                                        <div class="w-75 d-inline-block v-middle pl-2">
                                            <h5 class="message-title mb-0 mt-1"><?php echo $name; ?></h5> <span class="font-12 text-nowrap d-block text-muted text-truncate"><?php echo $desc; ?></span> <span class="font-12 text-nowrap d-block text-muted"><?php echo $time; ?></span> </div>
                                    </a>
                                    <?php 
                                        }
                                    } else {
            ...
            <ul class="navbar-nav">
                ...
                <!-- ============================================================== -->
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="<?php echo isset($user_image) ? $user_image : '../assets/images/users/1.jpg'; ?>" alt="user" class="rounded-circle" width="31"></a>
                    <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                        <div class="d-flex no-block align-items-center p-3 mb-2 border-bottom">
                            <div class=""><img src="<?php echo isset($user_image) ? $user_image : '../assets/images/users/1.jpg'; ?>" alt="user" class="rounded" width="80"></div>
                            <div class="ml-2">
                                <h4 class="mb-0"><?php echo isset($user_name) ? $user_name : 'Steave Jobs'; ?></h4>
                                <p class=" mb-0"><?php echo isset($user_email) ? $user_email : 'varun@gmail.com'; ?></p>
